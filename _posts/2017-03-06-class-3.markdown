...
namespace Class3
{
  ...
  class Program
  {
    ...
    // Vsimnite si, ze tato metoda pracuje s objektami, len cez interface Object2D
    // a vobec ju nezaujima, ci je objekt typu Circle alebo Triangle.
...
=======
# Príklad č. 2: Objektová reprezentácia a implementácia listu
>>>>>>> 0e86ffe2496683c6c05c31e9d7da6000b842ba01
